    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        else
        {
            ...
            try{
                ...
                p.print("YO");
                st.executeUpdate("insert into inbox values('"+nameto+"','"+session.getAttribute("uname").toString()+"','"+message+"','"+session.getAttribute("actualname").toString()+"');");
                p.print("YO");
                ...
                {
                    RequestDispatcher rd = request.getRequestDispatcher("inbox1");
                rd.forward(request, response);
                }
                p.print("YO");
            }
